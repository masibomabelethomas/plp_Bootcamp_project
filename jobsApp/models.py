...
#  the image upload option to be optional function
    if instance.is_featured:
        # If the instance has a flag indicating it's featured
        return os.path.join('featured', filename)
    else:
        # If not featured, use a default path
...
class Job(models.Model):  
    ...
    # for image dynamic optional upload. 
